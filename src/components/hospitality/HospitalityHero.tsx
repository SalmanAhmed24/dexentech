...
import { CalendarMock } from "@/components/hospitality/mockups";
import { Button } from "@/components/ui/Button";
import { gsap, GSAP_EASE, usePrefersReducedMotion } from "@/lib/motion";

/**
 * Two visual lines, one <h1>. The tone split matches the design: the first
 * line sits at full brightness and the second drops to the muted ramp.
 */
const LINES = [
  { text: "Every property.", tone: "bright" },
  { text: "One operating system.", tone: "muted" },
] as const;
...
export function HospitalityHero() {
  ...
  return (
    <section
      ref={root}
      aria-labelledby="hospitality-hero"
      className="relative isolate overflow-hidden pt-[120px] pb-16 md:pb-20"
    >
      <div
        data-h="rule"
        aria-hidden="true"
      ...
      />
      {/* Same CSS-painted grid as the home hero — Figma draws 1,026 ellipses. */}
      <div
        aria-hidden="true"
      ...
      <div className="shell">
        <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)] lg:gap-14">
          <div>
            ...
            >
              HospitalityOS · AI hotel management software
            </p>
            ...
            >
              HospitalityOS runs your bookings, housekeeping, guests, and finance
              — so you don&rsquo;t.
            </p>
